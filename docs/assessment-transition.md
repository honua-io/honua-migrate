...
description: "The assess command moved from honua-esri-assess to honua-migrate: what each legacy entry point maps to, and how long the old names keep working."

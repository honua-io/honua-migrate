...
This document is generated from the versioned disposition data in [`upstream/src/migration/widget-dispositions.ts`](https://github.com/honua-io/honua-migrate/blob/trunk/packages/javascript/upstream/src/migration/widget-dispositions.ts) (v1.1.0); the `honua-js-migrate widgets` scanner consumes the same data, so the scanner report and this guide cannot drift apart.
